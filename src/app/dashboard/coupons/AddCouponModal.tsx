...
import api from "@/lib/api"; // <-- import your axios instance here
...
export default function AddCouponModal({ onClose, onAdd }: AddCouponModalProps) {
    ...
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-6">
      <div className="bg-surface w-full max-w-2xl rounded-3xl shadow-2xl overflow-hidden">
        ...
        <div className="px-8 py-6 border-b border-border flex justify-between items-center">
          <div>
            <h2 className="font-brand text-2xl">Add Coupon</h2>
            <p className="text-sm text-text-secondary">Create a new coupon code</p>
          </div>
          <button
            onClick={onClose}
